...
interface Lesson { id: string; title: string; youtubeId: string | null; sortOrder: number; }
...
export default function CourseBuilderPage() {
  ...
  async function addLesson(sectionId: string) {
    ...
    setBusy(true);
    try {
      const data = await apiPost("/api/admin/courses/lessons", { sectionId, title: input.title, youtubeId: input.youtubeId });
  ...
  async function saveLesson(lessonId: string) {
    setBusy(true);
    try { await apiPost("/api/admin/courses/lessons/update", { lessonId, title: lessonEdit.title, youtubeId: lessonEdit.youtubeId }); setEditingLesson(null); notify("success", "Lesson updated."); await loadCourse(); }
